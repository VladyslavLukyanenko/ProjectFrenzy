...
namespace ProjectFrenzy.Core.Model
{
  ...
  public class Proxy : ViewModelBase
  {
    ...
    [Reactive, DataMember] public string Password { get; set; }
    [Reactive, DataMember] public string Username { get; set; }
    ...
    public static bool TryParse(string raw, out Proxy proxy)
    {
      ...
      proxy = new Proxy {Password = pwd, Url = rawUrl, Username = uname};
      return true;
    }
