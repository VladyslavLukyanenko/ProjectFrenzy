...
namespace ProjectFrenzy.AvaloniaUI.Controls
{
    public class ClippedBorder
        : Border
    {
        public static readonly AttachedProperty<bool> ClipToBorderProperty =
            AvaloniaProperty.RegisterAttached<ClippedBorder, Control, bool>("ClipToBorder");

        public static bool GetColumn(Control element)
        {
            return element.GetValue(ClipToBorderProperty);
        }

        public static void SetColumn(Control element, bool value)
        {
            element.SetValue(ClipToBorderProperty, value);
        }
